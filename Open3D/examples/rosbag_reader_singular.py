...
if __name__ == '__main__':
    ...
    bag_file = input("Please make sure to have the directory inside the dataset folders. Enter the directory name: ")
    bag_file_path = os.path.join('datasets', bag_file)
    output_dir = os.path.join('datasets', 'extracted_frames')
